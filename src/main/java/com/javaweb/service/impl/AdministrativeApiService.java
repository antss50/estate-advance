...
//
//            if (!allWards.isEmpty()) {
//                // Lọc bỏ những ward có code null hoặc rỗng
//                List<WardEntity> validWards = allWards.stream()
//                        .filter(w -> w.getCode() != null && !w.getCode().trim().isEmpty())
//                        .collect(Collectors.toList());
//
//                if (validWards.size() < allWards.size()) {
//                    System.err.println("Cảnh báo: Đã bỏ qua " + (allWards.size() - validWards.size()) + " xã/phường do code bị null.");
//                }
//
//                wardRepository.saveAll(validWards);
//                System.out.println("Đã lưu " + validWards.size() + " xã/phường");
//            }
//
